...
import { LaunchPool, LaunchPad, PreProject, Project, VestingType } from "../../src/types/PurrLaunchPadType.sol";
...
contract PurrLaunchPadTest is BaseTest {
    ...
    PurrLaunchPad public purrLaunchPad;
    ...
    function setUp() public {
        purrLaunchPad = new PurrLaunchPad(users.admin);
    }
    ...
    function test_CreateProject_VESTING_TYPE_MILESTONE_CLIFF_FIRST_ShouldCreateLaunchPad() public {
        ...
        (
            ...
            uint256 _ticketSize,
            VestingType _typeVesting
        ) = purrLaunchPad.launchPadInfo(_projectId);
    ...
    function test_CreateProject_VESTING_TYPE_MILESTONE_CLIFF_FIRST_ShouldCreateLaunchPool() public {
        ...
        (
            ...
            uint256 _totalAirdrop,
            VestingType _typeVesting
        ) = purrLaunchPad.launchPoolInfo(_projectId);
    ...
    function test_UpdateProject_VESTING_TYPE_MILESTONE_CLIFF_FIRST_ShouldUpdateProject() public {
        ...
        vm.prank(users.admin);
        purrLaunchPad.updateProject(_projectId, preProjectUpdate, launchPoolUpdate, launchPadUpdate);
